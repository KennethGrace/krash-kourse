...
Before we get ahead of ourselves though, I want to begin with an introduction to the simplest object class, the boolean. A boolean has only one property and only two possible states, true and false.
...
[*number-and-strings.py*](numbers-and-strings.py) - Figure 1.4
```python
print(a.__add__)
