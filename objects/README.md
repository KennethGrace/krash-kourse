...
One solution would be to treat every cup of coffee as a discrete entity, an Object. Every cup of coffee will have some possibly unique procedure for brewing and dispensing as well as some properties detailing how much milk and what kinds of flavoring to add. Think about the difference between an Americano, a Latte, and a Macchiato. This is the essential nature of an object, methods (how the coffee is prepared) and properties (what spices and milks are in the coffee and what are their ratios).
